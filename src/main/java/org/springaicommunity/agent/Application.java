...
public class Application {
    ...
    CommandLineRunner commandLineRunner(
            ChatClient.Builder chatClientBuilder, @Value("${agent.skills.paths}") List<Resource> skillPaths) {
        ChatClient chatClient = buildChatClient(chatClientBuilder, skillPaths);
        return args -> runInteractiveLoop(chatClient);
    }

    private ChatClient buildChatClient(ChatClient.Builder chatClientBuilder, List<Resource> skillPaths) {
